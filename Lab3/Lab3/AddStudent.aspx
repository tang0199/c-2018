...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
        ...
        <asp:DropDownList ID="ddlCourse" runat="server" Height="25px" Width="200px" OnSelectedIndexChanged="ddlCourse_SelectedIndexChanged" AutoPostBack="True">
            <asp:ListItem Value="-1">Select one course</asp:ListItem>
        </asp:DropDownList>
